package com.codexp.iam.iam.infrastructure.messaging;
...
public class DomainEventPublisher {
    ...
    public void publishUserRegistered(UserRegisteredEvent event) {
        ...
        rabbitTemplate.convertAndSend(RabbitMQConfig.IAM_EXCHANGE, RabbitMQConfig.ROUTING_KEY_CREATED, event);
    }
    ...
    public void publishUserProfileUpdated(UserProfileUpdatedEvent event) {
        ...
        rabbitTemplate.convertAndSend(RabbitMQConfig.IAM_EXCHANGE, RabbitMQConfig.ROUTING_KEY_UPDATED, event);
    }

    public void publishUserDeleted(UserDeletedEvent event) {
        log.info("Publicando UserDeletedEvent para userId={}", event.getUserId());
        rabbitTemplate.convertAndSend(RabbitMQConfig.IAM_EXCHANGE, RabbitMQConfig.ROUTING_KEY_DELETED, event);
    }
}
